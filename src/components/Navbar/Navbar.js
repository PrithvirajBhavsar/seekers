      ...
      >
        <div className="navbar-brand">
          <a className="navbar-item" href="/">
            <p className="title is-4">Seekers</p>
            {/* <svg
              width="640"
              height="160"
              viewBox="0 0 640 160"
          ...
          <a
            ...
            role="button"
            className={`navbar-burger ${dropdown && " is-active"}`}
            aria-label="menu"
            aria-expanded="false"
        ...
        <div
          ...
          className={`navbar-menu ${dropdown && " is-active"}`}
        >
          <div className="navbar-start">
            ...
            <Link to="/applied" className="navbar-item">
              Applied
            </Link>
          ...
          <div className="navbar-end">
            <div className="navbar-item">
              <div className="buttons">
                <Button unstyled className="button is-white">
                  Sign up
                </Button>
                <Button
                  onClick={() => {
